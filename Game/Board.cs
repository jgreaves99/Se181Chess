namespace ChessSE181.Game
{
    public class Board
    {
        ...
        {    
            ...
            spaces[0][2] = new Tile(0, 2, whiteBishop1);
            ...
            spaces[7][2] = new Tile(7, 2, blackBishop1);
            ...
            spaces[7][7] = new Tile(7, 7, blackBishop2);
            
            blackRook1.setTile(spaces[7][0]);
            blackBishop1.setTile(spaces[7][1]);
            blackKnight1.setTile(spaces[7][2]);
            blackQueen.setTile(spaces[7][3]);
            blackKing.setTile(spaces[7][4]);
            blackRook2.setTile(spaces[7][5]);
            blackBishop2.setTile(spaces[7][6]);
            blackKnight2.setTile(spaces[7][7]);
